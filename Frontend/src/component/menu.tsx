export const Menu = ({onDefineShiftJour,onHandleAdd,onSalaireAdd,onDefineShiftNuit,idAgent,onShiftAgent,onDeleteAgent}) => {
    return (
        <div className={"d-menu"}>
            ...
            <div className={"d-option"} id={idAgent} ><span id={idAgent} onClick={onDeleteAgent}>Supprimer un agent</span></div>
        </div>
    );
};
