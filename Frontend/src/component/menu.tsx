export const Menu = ({onDefineShiftJour,onHandleAdd,onDefineShiftNuit,idAgent,onShiftAgent}) => {
    return (
        <div className={"d-menu"}>
            ...
            <div className={"d-option"} id={idAgent}><span id={idAgent} onClick={onHandleAdd}>Rapour du mois</span></div>
