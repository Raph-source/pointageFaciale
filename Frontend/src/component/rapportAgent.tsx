...
export const RapportAgent = ({handleRemove,idAgent,handleGetReportAgent}) => {
    ...
    const onChange = async (e) => {
        ...
        console.log(Ndata)
        const response = await  handleGetReportAgent(Ndata)//axios.get(`http://localhost:3000/rapport-pointage-departement/${Ndata.idDepartement}/${Ndata.mois}`)
        reset()
